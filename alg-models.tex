...
In section 1, we define different theories with the interval type and describe several constructions in these theories.
We also define a weak univalence axiom and prove that it implies a part of the usual version of this axiom.
In section 2, we define a model structure on the category of models of a dependent type theory
...
In this section for every regular theory $T$ under $coe_1 + \sigma + Path + wUA$, we define a model structure on the category of models of $T$.
...
For every morphism of theories $f : \mathbb{T} \to \mathbb{T}'$ there is a functor $f^* : \Mod{\mathbb{T}'} \to \Mod{\mathbb{T}}$ which was constructed in \cite{alg-tt}.
