...
Let $Path_0$ be a theory with function symbols $HPath : (ty,0) \times (tm,0) \times (tm,0) \to (ty,0)$, $path : (tm,1) \to (tm,0)$, and $at : (tm,0) \times (tm,0) \to (tm,0)$, and the following axioms:
...
Let $\mathbb{T}$ be a theory under $I$.
