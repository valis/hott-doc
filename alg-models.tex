...
We will construct this model structure by means of the following result from \cite{f-model-structures}:
...
We will prove some of the conditions of \rthm{model-structures} in the following two lemmas:
\begin{lem}
...
\begin{lem}
Maps $\langle p_0, p_1 \rangle : P(X) \to X \times X$ have RLP with respect to $\J_{\I_{ty}}$.
\end{lem}
\begin{proof}
...
\end{thm}
\begin{proof}
We already checked most of the conditions; we are left to show that $p_0 : P(X) \to X$ has RLP with respect to $\I$.
