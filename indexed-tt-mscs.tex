...
\begin{example}
A map of spectra $f : A \to B$ is an equivalence if and only if $\Sigma^n(f) \circ - : U_S(A)_n \to U_S(B)_n$ is an equivalence for all $n : \mathbb{N}$.
...
Now, \rlem{trunc-id} implies that a map of spectra $f$ is $k$-truncated if and only if $\Sigma^n(f) \circ - : U_S(A)_n \to U_S(B)_n$ is $k$-truncated for all $n : \mathbb{N}$.

It follows that a map of spectra is $k$-truncated if and only if it is an equivalence.
Indeed, since $(\Sigma^n(f) \circ -) = \Omega^{k+2}(\Sigma^{n+k+2}(f) \circ -)$ and $\Sigma^{n+k+2}(f) \circ -$ is $k$-truncated, $\Sigma^n(f) \circ -$ is $(-2)$-truncated.
Thus, $\Sigma^n(f) \circ -$ is an equivalence for all $n : \mathbb{N}$.
\end{example}
