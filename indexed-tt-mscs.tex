...
Constructions (such as products) in type theory are usually defined for all types, but we will often assume only that some construction is defined only for some specific types.
This allows us to prove theorems in a more general form.
...
Another reason why we do not assume that constructions are defined for all types is that we might want to add these constructions with some restrictions.
