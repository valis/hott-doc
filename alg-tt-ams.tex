...
\begin{defn}
Let $\mathbb{T}_0$ be a prestable theory.
A \emph{contextual theory under $\mathbb{T}_0$} is a prestable theory $\mathbb{T}$ such that the following conditions hold:
\begin{enumerate}
...
\[ \sigma(A^1_1, \ldots A^1_{n_1}.\ b_1, \ldots A^k, \ldots A^k_{n_k}.\ b_k) \]
