...
Finally, we give a few examples of such theories.
...
\begin{center}
\def\extraVskip{1pt}
\Axiom$\fCenter \Gamma \vdash ctx$
\noLine
\UnaryInf$\fCenter \Gamma \vdash a_i : A_i[x_1 \mapsto a_1, \ldots x_{i-1} \mapsto a_{i-1}]$
\noLine
\UnaryInf$\fCenter x_1 : A_1, \ldots x_k : A_k, y_1 : C_1, \ldots y_m : C_m \vdash B$
\def\extraVskip{2pt}
\UnaryInf$\fCenter \Gamma, y_1 : C_1', \ldots y_m : C_m' \vdash subst^m_{p,n,k}(B, a_1, \ldots a_k)$
\DisplayProof
\end{center}
where $C_i' = subst^i_{ctx,n,k}(C_i, a_1, \ldots a_k)$.
