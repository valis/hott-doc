...
\begin{enumerate}
\item There exists a set of function symbols $\mathcal{F}_0$ such that the set of funtion symbols of $\mathbb{T}$ consists of
...
El & : (tm,0) \to (ty,0) \\
\sigma & : s_1 \times \ldots \times s_k \to (p,0) \\
\sigma_U & : U(s_1) \times \ldots \times U(s_k) \to (tm,0)
\end{align*}
for every function symbol $\sigma : s_1 \times \ldots \times s_k \to (p,0)$ of $\mathbb{T}$,
