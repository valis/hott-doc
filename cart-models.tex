...
\AxiomC{$\Gamma \vdash$}
\RightLabel{, for every $f : \Delta^m \to \Delta^n \in \Delta^{>0}_-$}
\UnaryInfC{$\Gamma, x : \Delta^m \vdash \degen{f} : \Delta^n$}
\DisplayProof
\end{center}
...
\AxiomC{$\Gamma \vdash d : \Delta^1$}
\RightLabel{, for every $0 \leq i \leq 1$}
\TrinaryInfC{$\Gamma \vdash fill^1_i(x. A, a, d) : A[x \repl d]$}
\DisplayProof
\end{center}

\medskip
\begin{center}
\AxiomC{$\Gamma, x : \Delta^n \vdash A\ type$}
\AxiomC{$\Gamma, y : \Delta^{n-1} \vdash a_j : A[x \repl \face{\delta^n_j}(y)]$}
\AxiomC{$\Gamma \vdash d : \Delta^n$}
\RightLabel{, for every $0 \leq i \leq n$}
\TrinaryInfC{$\Gamma \vdash fill^n_i(x. A, a_0, \ldots a_{i-1}, a_{i+1}, \ldots a_n, d) : A[x \repl d]$}
\DisplayProof
\end{center}
