...
\section{Simplicial localization of a model}
...
In this section we prove that the homotopy coherent nerve of the simplicial localization of $C(M)$ is
categorically equivalent to the quasicategory $N(M)$ constructed in the previous section.
We will use the following notation in this section: functors $N : \Cat \to \sSet$ is the ordinary nerve functor,
$N_\Delta : \Cat_\Delta \to \sSet$ is the homotopy coherent nerve functor defined in \cite{lurie-topos},
and $N_T : \Mod{T} \to \sSet$ is the nerve functor constructed in the previous section.
