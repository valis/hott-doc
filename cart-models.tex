...
\title{Equivalence between locally cartesian (closed) quasicategories and models of homotopy type theory}
...
In this section we recall the definition of the category $\cat{Cat}_\square$ of cubically enriched categories and Quillen adjunction between
the cateogry simplicial sets $\sSet$ (with Joyal model structure) and $\cat{Cat}_\square$.
We also define Quillen adjunction between $\cat{Cat}_\square$ and categories of models of suitable algebraic dependent type theories.
