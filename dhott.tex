...
\begin{example}
If $\scat{C}$ is a combinatorial type-theoretic semi-fibration category and $\scat{J}$ is a small category, then $D^*((\scat{C}^\scat{J})_!)$ satisfies the conditions of \rprop{coproducts}, where $\scat{C}^\scat{J}$ is equipped with the injective structure.
