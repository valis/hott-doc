...
We will say that $S$ is closed under \emph{coidentity types} if, for every map $i : U \to V$ in $S$, there exist cylinder objects $C(U)$ for $U$ and $C(V)$ for $V$
and a map of cylinder objects $C(i) : C(U) \to C(V)$ such that the map $C(U) \amalg_{(U \amalg U)} (V \amalg V) \to C(V)$ belongs to $\Icof[S]$.
...
\end{lem}
\begin{proof}
Let $P(Y)$ be a path object for a fibration $Y \twoheadrightarrow \Gamma$ which belongs to $\Iinj[S]$.
By \rlem{subfib-model-cats}, we just need to prove that the fibration $P(Y) \twoheadrightarrow Y \times_\Gamma Y$ belongs to $\Iinj[S]$.
...
such that the map $i' : W \to C(V)$ belongs to $\Icof[S]$, where $W = C(U) \amalg_{(U \amalg U)} (V \amalg V)$.
...
Since $i'$ belongs to $\Icof[S]$ and $Y \twoheadrightarrow \Gamma$ belongs to $\Iinj[S]$, we have a lift $h''' : C(V) \to Y$.
