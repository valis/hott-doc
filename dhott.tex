...
\begin{prop}[pushouts]
Let $\scat{B}$ be a category with fibrations, let $\scat{C}$ be a simplicial right proper type-theoretic model category, and let $F : \scat{B} \to \scat{C}$ be a functor between them.
