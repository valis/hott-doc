...
$T' = Lang(X) \cup \{\,\sststile{}{} (\Gamma, x : I \vdash H\ \type) \land (\Gamma \vdash O_{u(A)} \deq H[left])\,\}$,
...
The only axiom that mentions $H$ is $\sststile{}{} (\Gamma, x : I \vdash H\ \type) \land (\Gamma \vdash O_{u(A)} \deq H[left])$.
