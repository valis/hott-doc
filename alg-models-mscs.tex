...
Thus if we have $\sigma$ rule, then equation
\[ \vdash J(A, \lambda x y z.\,D, \lambda x.\,d, a, a, refl(a)) \deq d[x \repl a] \]
holds.
...
There is an obvious morphism $f : HPath \to Path$ such that
\[ f(a \idtype a') = Path(\lambda x.\,ty(a), a, a'). \]
