...
In section~\ref{sec:alg-th}, we briefly discuss the formalism of essentially algebraic theories, which we use to give a general definition of a type theory.
...
We assume that all theories have axioms asserting that all function symbols commute with $subst_{p,n,k}$.
...
Let us construct vertical arrows.
