...
Let $\scat{C}'$ be a full subcategory of $\scat{C}$.
We will say that $f : X \to Z$ is a \emph{quasifibration relative to $\scat{C}'$} if the condition above holds whenever $Z$ and $Z'$ belong to $\scat{C}'$.
