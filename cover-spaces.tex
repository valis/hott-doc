...
For sets of the form $\{ V \mid V = V_1 \rb \ldots \rb V_n = S \}$, this follows from \rlem{rb-point} and the fact that $S$ is open.
...
\rprop{embedding-injective} implies that $S$ is separated.
