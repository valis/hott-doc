...
\begin{center}
\AxiomC{}
\UnaryInfC{$\Gamma \mid \cdot \vdash \top\ \type$}
\DisplayProof
\qquad
\AxiomC{}
...
Similarly, we can define canonical pullback types:
\begin{center}
\AxiomC{$\Gamma \vdash f : \Hom(A,C)$}
\AxiomC{$\Gamma \vdash g : \Hom(B,C)$}
\BinaryInfC{$\Gamma \mid \cdot \vdash \fs{pb}(f,g)\ \type$}
\DisplayProof
\end{center}
\medskip
...
\AxiomC{$\Gamma \vdash f : \Hom(A,C)$}
\AxiomC{$\Gamma \vdash g : \Hom(B,C)$}
\AxiomC{$\Gamma \mid \Delta \vdash t : \fs{pb}(f,g)$}
\TrinaryInfC{$\Gamma \mid \Delta \vdash \pi_1(f,g,t) : A$}
\DisplayProof
\end{center}
\medskip
...
\AxiomC{$\Gamma \vdash g : \Hom(B,C)$}
\AxiomC{$\Gamma \mid \Delta \vdash t : \fs{pb}(f,g)$}
\TrinaryInfC{$\Gamma \mid \Delta \vdash \pi_2(f,g,t) : B$}
\DisplayProof
\end{center}
