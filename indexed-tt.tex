...
\item \label{it:fib-dep} $\Fib$ is closed under identity types and $\| A \|\text{-}\fs{elim}$ and $\| A \|\text{-}\fs{elim_h}$ are definable.
\item \label{it:fib-dep-local} $\Fib$ is closed under identity types and $\| A \|\text{-}\fs{elim}$ and $\| A \|\text{-}\fs{elim_h}$ are definable when $E$ is the empty context.
\end{enumerate}
\end{prop}
\begin{proof}
