...
\begin{lem}
Connected maps are left orthogonal to fibrations.
\end{lem}
\begin{proof}
...
Let $\mathcal{L}$ and $\mathcal{R}$ be a pair of classes of maps such that maps in $\mathcal{L}$ are left orthogonal to maps in $\mathcal{R}$.
Then the type of factorizations of a map into a map in $\mathcal{L}$ followed by a map in $\mathcal{R}$ is a proposition.
The pair $(\mathcal{L},\mathcal{R})$ is called an \emph{orthogonal factorization system} if this proposition is true.

\begin{prop}
Let $\mathcal{R}$ be a class of maps.
Then the class of maps $\mathcal{L}$ such that $(\mathcal{L},\mathcal{R})$ is an orthogonal factorization system is essentially unique.
...
If $\Fib$ is locally reflective and closed under compositions, then $(\mathcal{L},\Fib)$ is an orthogonal factorization system, where $\mathcal{L}$ is the class of connected maps.
The converse is also true in the sense that if $(\mathcal{L},\Fib)$ is an orthogonal factorization system for some class of maps $\mathcal{L}$, then $\Fib$ is locally reflective and closed under compositions.
\end{thm}
\begin{proof}
% TODO
\end{proof}
