...
\begin{example}
The canonical indexing of a dependent type theories over itself has strict dependent products if and only if it has $\Pi$-types.
\end{example}
...
% 1. (Локальная) декартовая замкнутость.
% 2. Вселенная Prop и прочие вселенные.
% 3. Regular categories and propositional truncation?
% 4. Other factorization systems, modalities, and localizations?
