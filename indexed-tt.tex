...
\end{prop}
\begin{proof}
If the theory has weak dependent coproducts, then it has coproducts by \rlem{dep-coprod-coprod}.
...
We can define its weak version as usual by replacing the judgemental equality with a propositional one.
...
\begin{align*}
h_1(b) & : \Id(\amalg\text{-}\fs{elim}(w.D,y.d_1,z.d_2,x.d_3)[\fs{inl}(y)[b/y]/w], d_1[b/y]) \\
h_2(c) & : \Id(\amalg\text{-}\fs{elim}(w.D,y.d_1,z.d_2,x.d_3)[\fs{inr}(z)[c/z]/w], d_2[c/z])
\end{align*}

\[ \xymatrix{ \fs{glue}(a)_*(\amalg\text{-}\fs{elim}(w.D,y.d_1,z.d_2,x.d_3)[\fs{inl}(y)[f\,a/y]/w]) \ar@{=}[r] \ar@{=}[d] & d_1'[a/w] \ar@{=}[d]^{d_3[a/x]} \\
              \amalg\text{-}\fs{elim}(w.D,y.d_1,z.d_2,x.d_3)[\fs{inr}(z)[g\,a/z]/w] \ar@{=}[r]_-{h_2(g\,a)} & d_2[g\,a/z]
            } \]
The last square must commute up to a homotopy $h_3(a)$.
The top arrow in this square is $\pmap(x.\,\fs{glue}(a)_*(x), h_1(f\,a)[\rho(\fs{glue}(a))])$ and the left arrow is defined by path induction on $\fs{glue}(a)$.
