...
The second problem is that the definition of $h$-initial objects involves propositional trunctions, but they might not exist in general.
We solve this problem by replacing the condition of connectedness by a weaker condition which can be formulated without propositional trunctions.
...
\subsection{The initial type theorems}
