...
\BinaryInfC{$\Gamma \mid \Delta, z : \coprod_{i : I} B, E \vdash \coprod\text{-}\fs{elim}(z.D, i x.d) : D$}
\DisplayProof
\end{center}
\medskip
...
Then the following conditions are equivalent:
\begin{enumerate}
\item These constructions have the universal property of coproducts in the empty context.
\item The local weak unstable eliminator is definable.
\item The global weak unstable eliminator is definable.
\end{enumerate}
\end{prop}
