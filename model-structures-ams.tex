...
This class of weak equivalences is the smallest class of weak equivalences among model structures with this class of cofibrations.
...
\begin{itemize}
\item $\we$ has the 2-out-of-3 property, that is given composable morphisms $f,g$,
...
Let $\we_\I$ be the class of weak equivalences, and let $\J_\I$ be a set of generating trivial cofibrations.
Then we can verify the conditions of \rprop{model-cat}:
\begin{description}
