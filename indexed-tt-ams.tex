...
A similar condition was defined in \cite[Definition~5]{gen-hedberg}: a type $X$ is \emph{populated}, written $\mathrm{isPop}(X)$, if every constant endofunction on $X$ has a fixed point.
