...
for every substitution $\rho$ consisting of $\Rightarrow_s$-normal forms, if $U(t)[\rho] \in \Term_{T,\varphi}^c$, then $t' (\Rightarrow_{sf} \Rightarrow_s^\nf)^* s'$,
where $t'$ and $s'$ are $\Rightarrow_s$-normal forms of $U(t)[\rho]$ and $U(\nf^t(s))[\rho]$, respectively, where $\nf^t(s)$ is the $\Rightarrow_{T,\varphi}^t$-normal of $s$.
