...
Since $T_{n-1}$ has separated axioms, \rlem{der-separated-closed} implies that $\sststile{}{} \varphi_\sigma[t_1/x_1, \ldots t_k/x_k]$ is derivable from $\mathcal{A}_d \cup \mathcal{A}_e$ in $T_{n-1}$ and hence in $T_n$.
\end{proof}
