...
Thus we can apply \rlem{conf-nf} with $A = \Term^d_{T,\varphi}$, $A' = \Term^t_{T,\varphi}$, $(\Rightarrow_0) = (\Rightarrow_{R_T^{tf}} \Rightarrow_{R^t_T,\varphi}^\nf)$, and $(\Rightarrow_1) = (\Rightarrow_{R^t_T,\varphi})$
to show that the terms $t$ and $s$ are joinable under $\Rightarrow_{tf}$.
...
Moreover, since $\mathcal{A}_{tf}'' < \mathcal{A}_{tf}'$, we can apply the induction hypothesis to conclude that $c''[e_p(a'[\rho'])/y,a'[\rho']/z]$ and $c''[e_p(b'[\rho'])/y,a'[\rho']/z]$ are joinable under $\Rightarrow_{tf}$.
