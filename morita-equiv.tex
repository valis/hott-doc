...
The theorem itself follows from \rcor{ty-elim}, \rprop{subst-elim}, and \rprop{ctx-elim}.
...
By \rlem{subst-red}, $R_T^s$ is strongly normalizing and confluent, so we just need to check that if $t \Rightarrow_{R_T^{sf}} s$,
