...
It is often easy to prove the first condition of \rlem{eq-char}, so the main problem is verifying the second one.
The following lemma shows that it follows from a simpler condition.
