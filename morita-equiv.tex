...
This does not imply confluence of $T_\Pi'$ immediately, but it is possible to prove confluence of $T_\Pi'$ using this fact and also the fact that it is strongly normalizing.
This proof is out of scope of this paper, so we will simply assume that $T_\Pi'$ is confluent.
...
Br \rprop{der-separated}, we may assume that $T$ is maximal.
...
By assumption, there exists a sequence of homotopies between $A$ and $B$, which are constant in $T \cup \mathcal{A}$.
