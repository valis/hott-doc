...
For each judgement $J$ of the form $\Gamma \vdash a \deq a'$ we define an equation $A(J)$:
\[ \alpha_{V,V,p,n,k}(\beta_{V,V,n,k}(\Delta, \Gamma, \rho), a, \rho) = \alpha_{V,V,p,n,k}(\beta_{V,V,n,k}(\Delta, \Gamma, \rho), a', \rho). \]
