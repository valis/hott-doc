...
Indeed, if $\varphi \ssststile{}{V} \psi$ is a theorem of $\mathbb{T}$, then $[\varphi]_\sim = [\psi]_\sim$; hence $\beta'_V(f)(\varphi) = \beta'_V(f)(\varphi)$.
...
Indeed, $\varphi \sim \psi$ if and only if $\varphi \ssststile{}{V} \psi$ is a theorem of $\mathbb{T}$,
