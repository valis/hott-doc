...
In this case we let $Subst_{n,k+1}(B, A, a_1, \ldots a_{k+1}) = f^*(A)$ and $q_{n,k}(B, A, a_1, \ldots a_{k+1}) = q(f,A)$ where $f$ is the composition of the section in $a_{k+1}$ and $q_{n,k}(B, ft_k(A), a_1, \ldots a_k)$.
