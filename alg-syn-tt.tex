...
\begin{defn}
Let $\mathbb{T}$ be a contextual Horn theory over a signature $\Sigma$ and let $\mathbb{T}'$ be a contextual Horn theory over a signature $\Sigma'$.
...
In this section we construct functors $C : \mathbb{T}_0/\ThT \to \CTh$ and $A : \CTh \to \mathbb{T}_0/\ThT$ which constitute an equivalence of categories.
...
\subsection{Functor $A : \CTh \to \mathbb{T}_0/\ThT$}

For every contextual theory $\mathbb{T} = ((\mathcal{T},\mathcal{F},\mathcal{P}),\mathcal{A})$ we define algebraic type theory $A(\mathbb{T})$.
For every function symbols $\sigma \in \mathcal{F}$, $\sigma : s_1 \times \ldots \times s_k \to s$,
    theory $A(\mathbb{T})$ has function symbol $\sigma : e(s) \times s_1 \times \ldots \times s_k \to s$,
