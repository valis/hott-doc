...
We define $\mathbb{T}_0 \in \ThT$ as the theory with the set of function symbols $ft_n : (ty,n) \to (ctx,n)$, $ty_n : (tm,n) \to (ty,n)$ and axioms asserting that $(ctx,0)$ is trivial.
