...
Then we define $\mathbb{T}_0 \in \Th_{\mathcal{C},\varnothing}$ as the theory with the set of function symbols $\{ * \} \cup \{ ft_n : Ctx_{n+1} \to Ctx_n\ |\ n \in \mathbb{N} \} \cup \{ ty_n : Tm_n \to Ctx_{n+1}\ |\ n \in \mathbb{N} \}$ and the following axioms:
\begin{align*}
...
Let $\mathcal{D} = \{ ty, tm \} \times \mathbb{N}$ be a set of sorts.
...
Given a theory $\mathbb{T}$ in $\Th_{\mathcal{D},\mathcal{P}_0}$ we say that it is \emph{functional} if the following conditions hold:
\begin{itemize}
\item If $\varphi \sststile{}{V} D^{n+1}_{ty}(A_1, \ldots A_{n+1}, A)$ and $\varphi \sststile{}{V} D^{n+1}_{ty}(A_1', \ldots A_{n+1}', A)$ are theorems of $\mathbb{T}$,
    then sequents $\varphi \sststile{}{V} D^n_{ty}(A_1, \ldots A_{n+1})$ and $\varphi \sststile{}{V} A_{n+1} = A_{n+1}'$ are also theorems of $\mathbb{T}$.
\item If $\varphi \sststile{}{V} D^n_{tm}(A_1, \ldots A_n, a, A)$ and $\varphi \sststile{}{V} D^n_{tm}(A_1', \ldots A_n', a, A')$ are theorems of $\mathbb{T}$,
    then sequents $\varphi \sststile{}{V} D^n_{ty}(A_1, \ldots A_n, A)$ and $\varphi \sststile{}{V} A = A'$ are also theorems of $\mathbb{T}$.
\end{itemize}

\begin{prop}
Category $\mathbb{T}_0/\Th_{\mathcal{C},\varnothing}$ is equivalent to the full subcategory of $\Th_{\mathcal{D},\mathcal{P}_0}$ of total functional theories.
\end{prop}
\begin{proof}
Let $\mathbb{T}$ be a theory under $\mathbb{T}_0$.
Then we define a theory $F(\mathbb{T}) \in \Th_{\mathcal{D},\mathcal{P}_0}$
\end{proof}
