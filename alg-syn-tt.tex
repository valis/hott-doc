...
If $A$ is a term of sort $Ctx_{k+2}$, $B$ is a term of sort $Ctx_n$, and $a_1$, \ldots $a_k$ are terms of sort $Tm_n$, then we write $Subst^2_{n,k}(B, A, a_1, \ldots a_k)$ for
\[ Subst_{n+1,k+1}(B', A, wk(B', a_1), \ldots wk(B', a_k), v_0(B')) \]
where $B' = Subst_{n,k}(B, ft(A), a_1, \ldots a_k)$.
