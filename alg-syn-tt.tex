...
Theory $U(\mathbb{T})$ has the same function symbols, predicate symbols and aixoms as $\mathbb{T}$, and also the following symbols:
\begin{align*}
Type_n & : (ty,n) \\
El_n & : (tm,n) \to (ty,n)
\end{align*}
...
Finally, note that if $\mathbb{T}$ is stable, then usually $U(\mathbb{T})$ is also stable.
