...
We will say that morphisms $F$ and $G$ are \emph{equivalent} if for all $f \in \mathcal{F}_\Sigma$, $f : s_1 \times \ldots \times s_n \to s$ sequent $\sststile{}{x_1, \ldots x_n} F(f(x_1, \ldots x_n)) \cong G(f(x_1, \ldots x_n))$ is a theorem of $\mathbb{T}'$.
