...
\UnaryInfC{$\Gamma \vdash t \deq unit : \top$}
\DisplayProof
\end{center}
\end{example}
...
\DisplayProof
\quad
\AxiomC{$\Gamma, \top \vdash D$}
\AxiomC{$\Gamma \vdash d : D[unit]$}
\AxiomC{$\Gamma \vdash t : \top$}
\TrinaryInfC{$\Gamma \vdash \top\text{-}elim(D, d, t) : D[t]$}
\DisplayProof
\end{center}
...
\AxiomC{$\Gamma, \top \vdash D$}
\AxiomC{$\Gamma \vdash d : D[unit]$}
\BinaryInfC{$\Gamma \vdash \top\text{-}elim(D, d, unit) \deq d : D[unit]$}
\DisplayProof
\end{center}
\end{example}
...
$\Sigma : (ty,0) \times (ty,1) \to (ty,0)$, $pair : (tm,0) \times (tm,0) \to (tm,0)$, $proj_1 : (tm,0) \to (tm,0)$ and $proj_2 : (tm,0) \to (tm,0)$
and the following inference rules:
\medskip
\begin{center}
\AxiomC{$\Gamma, A \vdash B$}
\UnaryInfC{$\Gamma \vdash \Sigma(A, B)$}
\DisplayProof
\quad
\AxiomC{$\Gamma, A \vdash B$}
\AxiomC{$\Gamma \vdash a : A$}
\AxiomC{$\Gamma \vdash b : B[a]$}
\TrinaryInfC{$\Gamma \vdash pair(B, a, b)$}
\DisplayProof
\end{center}
...
\AxiomC{$\Gamma \vdash a : A$}
\AxiomC{$\Gamma \vdash b : B[a]$}
\TrinaryInfC{$\Gamma \vdash proj_1(pair(B,a,b)) \deq a : A$}
\DisplayProof
\end{center}
...
\AxiomC{$\Gamma \vdash a : A$}
\AxiomC{$\Gamma \vdash b : B[a]$}
\TrinaryInfC{$\Gamma \vdash proj_2(pair(B,a,b)) \deq b : B[a]$}
\DisplayProof
\end{center}
...
\begin{center}
\AxiomC{$\Gamma \vdash p : \Sigma(A, B)$}
\UnaryInfC{$\Gamma \vdash pair(B, proj_1(p), proj_2(p)) \deq p : \Sigma(A, B)$}
\DisplayProof
\end{center}
\end{example}
...
\begin{example}
The theory of identity types has function symbols $Id : (tm,0) \times (tm,0) \to (ty,0)$, $refl : (tm,0) \to (tm,0)$ and $J : (ty,3) \times (tm,1) \times (tm,0) \to (tm,0)$
and the following inference rules:
\medskip
\begin{center}
\AxiomC{$\Gamma \vdash a : A$}
\AxiomC{$\Gamma \vdash a' : A$}
\BinaryInfC{$\Gamma \vdash Id(a, a')$}
\DisplayProof
\quad
\AxiomC{$\Gamma \vdash a : A$}
...
\medskip
\begin{center}
\AxiomC{$\Gamma, A, A\!\uparrow, Id(v_1, v_0) \vdash D$}
\AxiomC{$\Gamma, A \vdash d : D[v_0, v_0, refl(v_0)]$}
\AxiomC{$\Gamma \vdash p : Id(a, a')$}
\TrinaryInfC{$\Gamma \vdash J(D, d, p) : D[a, a', p]$}
\DisplayProof
\end{center}
...
\AxiomC{$\Gamma, A \vdash d : D[v_0, v_0, refl(v_0)]$}
\AxiomC{$\Gamma \vdash a : A$}
\TrinaryInfC{$\Gamma \vdash J(D, d, refl(a)) \deq d[a] : D[a, a, refl(a)]$}
\DisplayProof
\end{center}
\end{example}
