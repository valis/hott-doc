...
Category $\algtt$ of algebraic type theory is the under category $\mathbb{T}_1 / \cat{Th}_\mathcal{C}$.
\end{defn}
...
\[ subst_{p,n+q,k+q}(\sigma_k(a_1, \ldots a_m), b_1'', \ldots b_k'', v_{n+q,q-1}, \ldots v_{n+1,0}) = \sigma_n(a_1', \ldots a_m') \]
for each $\sigma : (p_1,q_1) \times \ldots \times (p_n,q_n) \to (p,q)$ and $b_j : (tm,n)$ where
