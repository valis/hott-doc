...
\TrinaryInfC{$\Gamma \vdash pair(A, B, a, b)$}
\DisplayProof
\end{center}
...
\AxiomC{$\Gamma \vdash a : A$}
\AxiomC{$\Gamma \vdash b : B[a]$}
\TrinaryInfC{$\Gamma \vdash proj_1(A, B, pair(A, B, a, b)) \deq a : A$}
\DisplayProof
\end{center}
...
\AxiomC{$\Gamma \vdash a : A$}
\AxiomC{$\Gamma \vdash b : B[a]$}
\TrinaryInfC{$\Gamma \vdash proj_2(A, B, pair(A, B, a, b)) \deq b : B[a]$}
\DisplayProof
\end{center}
...
\begin{center}
\AxiomC{$\Gamma \vdash p : \Sigma(A, B)$}
\UnaryInfC{$\Gamma \vdash pair(A, B, proj_1(A, B, p), proj_2(A, B, p)) \deq p : \Sigma(A, B)$}
\DisplayProof
\end{center}
\end{example}
...
\AxiomC{$\Gamma \vdash a : A$}
\AxiomC{$\Gamma \vdash a' : A$}
\BinaryInfC{$\Gamma \vdash Id(A, a, a')$}
\DisplayProof
\quad
\AxiomC{$\Gamma \vdash a : A$}
\UnaryInfC{$\Gamma \vdash refl(A, a) : Id(A, a, a)$}
\DisplayProof
\end{center}

\medskip
\begin{center}
\AxiomC{$\Gamma, A, A\!\uparrow, Id(A\!\uparrow\uparrow, v_1, v_0) \vdash D$}
\AxiomC{$\Gamma, A \vdash d : D[v_0, v_0, refl(A\!\uparrow, v_0)]$}
\AxiomC{$\Gamma \vdash p : Id(A, a, a')$}
\TrinaryInfC{$\Gamma \vdash J(A, D, d, a, a', p) : D[a, a', p]$}
\DisplayProof
\end{center}
...
\AxiomC{$\Gamma, A \vdash d : D[v_0, v_0, refl(A\!\uparrow, v_0)]$}
\AxiomC{$\Gamma \vdash a : A$}
\TrinaryInfC{$\Gamma \vdash J(A, D, d, a, a, refl(A, a)) \deq d[a] : D[a, a, refl(A, a)]$}
\DisplayProof
\end{center}
\end{example}
