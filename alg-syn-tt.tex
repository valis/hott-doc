...
We will need the following lemmas from \cite{PHT}:
\begin{lem}[cong-a]
...
\begin{lem}
Let $T' = (\mathcal{F}',\mathcal{P}',\mathbb{T}') \in \Th_{\mathcal{S}'}$ be a subtheory of $T \in \Th_\mathcal{S}$.
Suppose that if $\sigma : s_1 \times \ldots \times s_n \to s$ and $s \in \mathcal{S}'$, then $\sigma \in \mathcal{F}'$.
