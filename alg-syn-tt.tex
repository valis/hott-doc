...
If $t$ is a variable, then the claim follows from \rlem{F-basic}~\eqref{F-var}.
...
By \rlem{F-basic}~\eqref{F-var}, $F(x_1, \ldots x_n)\!\downarrow\ \sststile{}{V} F(x_1, \ldots x_n) = x_n$.
...
By \rlem{F-basic}~\eqref{F-var} and \rlem{F-e}, $\sststile{}{V} F(\Gamma,y) \cong y_{e(y) = F(\Gamma)}$ is derivable.
