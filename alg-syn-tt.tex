...
% Сказать что-нибудь про композиционность.
...
For example, constructing models of dependent type theories is a difficult task because of so called coherence problem.
...
% Алгебраический подход позволяет разделить синтаксические детали и существенные аспекты теории.
