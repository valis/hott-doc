...
\begin{enumerate}
\item Если $\ll \Gamma \vdash A \rr = A' \dotsb \Gamma'$, то $\ll \Delta \vdash A[\rho] \rr = \rho'^*(A') \dotsb \Delta'$.
\item Если $\ll \Gamma \vdash a \Uparrow A \rr = a' : A' \dotsb \Gamma'$, то $\ll \Delta \vdash a[\rho] \Uparrow A[\rho] \rr = \rho'^*(a') : \rho'^*(A') \dotsb \Delta'$.
\item Если $\ll \Gamma \vdash a \Downarrow A \rr = a' : A' \dotsb \Gamma'$, то $\ll \Delta \vdash a[\rho] \Downarrow A[\rho] \rr = \rho'^*(a') : \rho'^*(A') \dotsb \Delta'$.
\item Если $\ll \Gamma \vdash A \red B \rr = H \dotsb \Gamma' \times I'$, то $\ll \Delta \vdash A[\rho] \red B[\rho] \rr = (\rho' \times I')^*(H) \dotsb \Delta' \times I'$.
\item Если $\ll \Gamma \vdash A \red^* B \rr = H \dotsb \Gamma' \times I'$, то $\ll \Delta \vdash A[\rho] \red^* B[\rho] \rr = (\rho' \times I')^*(H) \dotsb \Delta' \times I'$.
\item Если $\ll \Gamma \vdash a \red b \Downarrow A \rr = h : \pi_1^*(A') \dotsb \Gamma' \times I'$, то $\ll \Delta \vdash a[\rho] \red b[\rho] \Downarrow A[\rho] \rr = (\rho' \times I')^*(h) : \pi_1^* \rho'^*(A') \dotsb \Delta' \times I'$.
\item Если $\ll \Gamma \vdash a \red^* b \Downarrow A \rr = h : \pi_1^*(A') \dotsb \Gamma' \times I'$, то $\ll \Delta \vdash a[\rho] \red^* b[\rho] \Downarrow A[\rho] \rr = (\rho' \times I')^*(h) : \pi_1^* \rho'^*(A') \dotsb \Delta' \times I'$.
\end{enumerate}
\end{lem}
\begin{proof}
