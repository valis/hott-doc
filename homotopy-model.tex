...
\medskip
\begin{center}
\AxiomC{$\ll \Gamma \vdash a \Uparrow A_1 \rr = a : \langle id_\Gamma, i_0 \rangle^*(H_1) \dotsb \Gamma$}
\AxiomC{$\ll \Gamma \vdash A_i \red^* B \rr = H_i \dotsb \Gamma \times I$, $i \in \{1, 2\}$}
\RightLabel{, $B \in NF$}
\BinaryInfC{$\ll \Gamma \vdash a \Downarrow A_2 \rr = a' : \langle id_\Gamma, i_0 \rangle^*(H_2) \dotsb \Gamma$}
\DisplayProof
\end{center}
