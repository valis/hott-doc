...
Последнее требование, которое нам понадобится заключается в том, что поднятие гомотопий должно хорошо себя вести по отношению к структуре категории с атрибутами.
