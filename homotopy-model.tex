...
Индукцией несложно показать, что если $\ll \Gamma \vdash \Delta \rr = A'_n \ldots A'_1 \dotsb \Gamma'$, то $\ll \Gamma \vdash \rr = \Gamma'$, и $\ll \Gamma, \Delta \vdash \rr = \Gamma'.A'_1 \ldots A'_n$.
...
\bigskip
\item
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash A_{n+1} \rr = A'_{n+1} \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\UnaryInfC{$\ll \Gamma, x : A, \Delta, x_{n+1} : A_{n+1} \vdash \rr = \Gamma'.A'.A'_1 \ldots A'_n.A'_{n+1}$}
\DisplayProof
\medskip

По индукционному предположению $\ll \Gamma, \Delta[x := a] \vdash A_{n+1}[x := a] \rr = (a'.A'_1 \ldots A'_n)^*(A'_{n+1}) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$.
Следовательно $\ll \Gamma, \Delta[x := a], x_{n+1} : A_{n+1}[x := a] \vdash \rr = \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_n)^*(A'_{n+1})$.
...
\item
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash A_{n+1} \rr = A'_{n+1} \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\UnaryInfC{$\ll \Gamma, x : A, \Delta, x_{n+1} : A_{n+1} \vdash x_{n+1} \Uparrow A_{n+1} \rr = \langle id, id \rangle : \pi_{A'_{n+1}}^*(A'_{n+1}) \dotsb \Gamma.A'.A'_1 \ldots A'_{n+1}$}
\DisplayProof
\medskip

По индукционному предположению $\ll \Gamma, \Delta[x := a] \vdash A_{n+1}[x := a] \rr = (a'.A'_1 \ldots A'_n)^*(A'_{n+1}) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$.
Следовательно $\ll \Gamma, \Delta[x := a], x_{n+1} : A_{n+1}[x := a] \vdash x_{n+1} \Uparrow A_{n+1}[x := a] \rr = \langle id, id \rangle : \pi_{(a'.A'_1 \ldots A'_n)^*(A'_{n+1})}^*(a'.A'_1 \ldots A'_n)^*(A'_{n+1}) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_n)^*(A'_{n+1}) = (a'.A'_1 \ldots A'_{n+1})^*(\langle id, id \rangle) : (a'.A'_1 \ldots A'_{n+1})^* \pi_{A'_{n+1}}^*(A'_{n+1}) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_n)^*(A'_{n+1})$.
...
\bigskip
\item
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash y \Uparrow B \rr = b : B' \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash A_{n+1} \rr = A'_{n+1} \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\BinaryInfC{$\ll \Gamma, x : A, \Delta, x_{n+1} : A_{n+1} \vdash y \Uparrow B \rr = \pi_{A'_{n+1}}^*(b) : \pi_{A'_{n+1}}^*(B') \dotsb \Gamma'.A'.A'_1 \ldots A'_{n+1}$}
\DisplayProof
\medskip

По индукционному предположению $\ll \Gamma, \Delta[x := a] \vdash y[x := a] \Uparrow B[x := a] \rr = (a'.A'_1 \ldots A'_n)^*(b) : (a'.A'_1 \ldots A'_n)^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$,
и $\ll \Gamma, \Delta[x := a] \vdash A_{n+1}[x := a] \rr = (a'.A'_1 \ldots A'_n)^*(A'_{n+1}) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$.
По лемме~\rlem{weakening} $\ll \Gamma, \Delta[x := a], x_{n+1} : A_{n+1} \vdash y[x := a] \Uparrow B[x := a] \rr = \pi_{(a'.A'_1 \ldots A'_n)^*(A'_{n+1})}^*(a'.A'_1 \ldots A'_n)^*(b) : \pi_{(a'.A'_1 \ldots A'_n)^*(A'_{n+1})}^*(a'.A'_1 \ldots A'_n)^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_n)^*(A'_{n+1})$,
Теперь утверждение следует из того факта, что $a'.A'_1 \ldots A'_n \circ \pi_{(a'.A'_1 \ldots A'_n)^*(A'_{n+1})} = \pi_{A'_{n+1}} \circ a'.A'_1 \ldots A'_{n+1}$.

\bigskip
\item
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash b \Uparrow B_1 \rr = b_1 : i_0^*(H_1) \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash B_i \red^* C \rr = H_i \dotsb \Gamma'.A'.A'_1 \ldots A'_n \times I$, $i \in \{1, 2\}$}
\BinaryInfC{$\ll \Gamma, x : A, \Delta \vdash b \Downarrow B_2 \rr = i_1^*(ext(Con(H_1,Inv(H_2)),b_1)) : i_0^*(H_2) \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\DisplayProof
\medskip

По индукционной гипотезе $\ll \Gamma, \Delta[x := a] \vdash b[x := a] \Uparrow B_1[x := a] \rr = (a'.A'_1 \ldots A'_n)^*(b_1) : (a'.A'_1 \ldots A'_n)^* i_0^*(H_1) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$,
    и $\ll \Gamma, \Delta[x := a] \vdash B_i[x := a] \red^* C[x := a] \rr = (a'.A'_1 \ldots A'_n \times id_I)^*(H_i) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n) \times I$.
Следовательно $\ll \Gamma, \Delta[x := a] \vdash b[x := a] \Downarrow B_2[x := a] \rr = i_1^*(ext(Con((a'.A'_1 \ldots A'_n \times id_I)^*(H_1), Inv((a'.A'_1 \ldots A'_n \times id_I)^*(H_2))), (a'.A'_1 \ldots A'_n)^*(b_1))) : i_0^* (a'.A'_1 \ldots A'_n \times id_I)^*(H_2) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n) = (a'.A'_1 \ldots A'_n)^* i_1^*(ext(Con(H_1, Inv(H_2)), b_1)) : (a'.A'_1 \ldots A'_n)^* i_0^*(H_2) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$.

\bigskip
\item
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash B \rr = B' \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\UnaryInfC{$\ll \Gamma, x : A, \Delta \vdash B \red^* B \rr = \pi_1^*(B') \dotsb \Gamma'.A'.A'_1 \ldots A'_n \times I$}
\DisplayProof
\medskip

По индукционной гипотезе $\ll \Gamma, \Delta[x := a] \vdash B[x := a] \rr = (a'.A'_1 \ldots A'_n)^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$.
Следовательно $\ll \Gamma, \Delta[x := a] \vdash B[x := a] \red^* B[x := a] \rr = \pi_1^* (a'.A'_1 \ldots A'_n)^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n) \times I = (a'.A'_1 \ldots A'_n \times id_I)^* \pi_1^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n) \times I$.

\bigskip
\item
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash B \red C \rr = H_1 \dotsb \Gamma'.A'.A'_1 \ldots A'_n \times I$}
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash C \red^* D \rr = H_2 \dotsb \Gamma'.A'.A'_1 \ldots A'_n \times I$}
\BinaryInfC{$\ll \Gamma, x : A, \Delta \vdash B \red^* D \rr = Con(H_1, H_2) \dotsb \Gamma'.A'.A'_1 \ldots A'_n \times I$}
\DisplayProof
\medskip

По индукционной гипотезе $\ll \Gamma, \Delta[x := a] \vdash B[x := a] \red C[x := a] \rr = (a'.A'_1 \ldots A'_n \times id_I)^*(H_1) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$,
    и $\ll \Gamma, \Delta[x := a] \vdash C[x := a] \red^* D[x := a] \rr = (a'.A'_1 \ldots A'_n \times id_I)^*(H_2) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$.
Следовательно $\ll \Gamma, \Delta[x := a] \vdash B[x := a] \red^* D[x := a] \rr = Con((a'.A'_1 \ldots A'_n \times id_I)^*(H_1), (a'.A'_1 \ldots A'_n \times id_I)^*(H_2)) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n) = (a'.A'_1 \ldots A'_n \times id_I)^*(Con(H_1, H_2)) \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$.

\bigskip
\item
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash b \Downarrow B \rr = b' : B' \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\UnaryInfC{$\ll \Gamma, x : A, \Delta \vdash b \red^* b \Downarrow B \rr = b' \circ \pi_1 : I \to B' \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\DisplayProof
\medskip

По индукционной гипотезе $\ll \Gamma, \Delta[x := a] \vdash b[x := a] \Downarrow B[x := a] \rr = (a'.A'_1 \ldots A'_n)^*(b') : (a'.A'_1 \ldots A'_n)^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$.
Следовательно $\ll \Gamma, \Delta[x := a] \vdash b[x := a] \red^* b[x := a] \Downarrow B[x := a] \rr = (a'.A'_1 \ldots A'_n)^*(b') \circ \pi_1 : I \to (a'.A'_1 \ldots A'_n)^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n) = (a'.A'_1 \ldots A'_n)^*(b' \circ \pi_1) : I \to (a'.A'_1 \ldots A'_n)^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$.

\bigskip
\item
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash b \red c \Downarrow B \rr = h_1 : I \to B' \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\AxiomC{$\ll \Gamma, x : A, \Delta \vdash c \red^* d \Downarrow B \rr = h_2 : I \to B' \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\BinaryInfC{$\ll \Gamma, x : A, \Delta \vdash b \red^* d \Downarrow B \rr = con(h_1, h_2) : I \to B' \dotsb \Gamma'.A'.A'_1 \ldots A'_n$}
\DisplayProof
\medskip

По индукционной гипотезе $\ll \Gamma, \Delta[x := a] \vdash b[x := a] \red c[x := a] \Downarrow B[x := a] \rr = (a'.A'_1 \ldots A'_n)^*(h_1) : (a'.A'_1 \ldots A'_n)^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$,
    и $\ll \Gamma, \Delta[x := a] \vdash c[x := a] \red^* d[x := a] \Downarrow B[x := a] \rr = (a'.A'_1 \ldots A'_n)^*(h_2) : (a'.A'_1 \ldots A'_n)^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$,
Следовательно $\ll \Gamma, \Delta[x := a] \vdash b[x := a] \red^* d[x := a] \Downarrow B[x := a] \rr = con((a'.A'_1 \ldots A'_n)^*(h_1), (a'.A'_1 \ldots A'_n)^*(h_2)) : (a'.A'_1 \ldots A'_n)^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n) = (a'.A'_1 \ldots A'_n)^*(con(h_1, h_2)) : (a'.A'_1 \ldots A'_n)^*(B') \dotsb \Gamma'.a'^*(A'_1) \ldots (a'.A'_1 \ldots A'_{n-1})^*(A'_n)$,
