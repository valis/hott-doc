...
\Axiom$\fCenter \ll \Gamma, x : I' \vdash Red\ A\ B\ x \rr = H_1 \dotsb \Gamma' \times I'$
\noLine
...
\noLine
\UnaryInf$\fCenter \ll \Gamma, x : I' \vdash red\ a\ a'\ x \Downarrow A \rr = h_1 : \pi_{\Gamma'}^*(A') \dotsb \Gamma' \times I'$
\noLine
\UnaryInf$\fCenter \ll \Gamma, x : I' \vdash red^*\ a'\ a''\ x \Downarrow A \rr = h_2 : \pi_{\Gamma'}^*(A') \dotsb \Gamma' \times I'$
\noLine
\UnaryInf$\fCenter \ll \Gamma \vdash k \Uparrow I' \rr = k' : \Gamma' \to \Gamma' \times I'$
\def\extraVskip{2pt}
...
\AxiomC{$\ll \Gamma_1, \Gamma_2 \vdash A_i \red^* B \rr = H_i \dotsb \Gamma_1'.\Gamma_2' \times I'$, $i \in \{1, 2\}$}
\BinaryInfC{$\ll \Gamma_1, \Gamma_2 \vdash a \Downarrow A_2 \rr = i_1^*(ext(Con(H_1,Inv(H_2)),a_1)) : i_0^*(H_2) \dotsb \Gamma_1'.\Gamma_2'$}
\DisplayProof
\medskip

По индукционной гипотезе $\ll \Gamma_1, \Delta, \Gamma_2 \vdash a \Uparrow A_1 \rr = \pi_{\Delta'}^*(a_1) : \pi_{\Delta'}^* i_0^*(H_1) \dotsb \Gamma'.\Delta'$, и
