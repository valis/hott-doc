...
\medskip
\begin{center}
\AxiomC{$\ll \Gamma \vdash a \Uparrow A_1 \rr = a' : A' \dotsb \Gamma'$}
\AxiomC{$\ll \Gamma \vdash A_2 \rr = A' \dotsb \Gamma'$}
\RightLabel{, $A_1 \deq_\phi A_2$}
\BinaryInfC{$\ll \Gamma \vdash a \Downarrow A_2 \rr = a' : A' \dotsb \Gamma'$}
\DisplayProof
\end{center}
\bigskip
...
Пусть $\ll \Gamma \vdash Red^*\ A\ C\ k \rr = H \dotsb \Gamma$, и $\ll \Gamma \vdash Red^*\ A\ C\ k \rr = H' \dotsb \Gamma'$.
...
Случай $red^*$ аналогичен предыдущему.
\end{proof}
