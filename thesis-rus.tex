...
По \dprop{th-fib} морфизм $\eta_{F_0} : F_0 \to \fs{Th}^\lambda(\fs{Cl}^\lambda(F_0))$ факторизуется через $F_0 \to F_\lambda$.
...
По \dprop{transferred} нам достаточно проверить, что TODO
