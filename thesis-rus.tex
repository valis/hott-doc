...
\end{prop}
\begin{proof}
По \dprop{th-adj} нам достаточно доказать это утверждение для категории $\Th$.
...
Если $\lambda < \mu$, то функтор $\Th^\lambda \to \Th^\mu$ является левым споряженным по \dprop{th-adj}.
...
Функтор $\fs{Cl}^\lambda : \Th^\lambda \to \bcat{Cart}^\lambda$, определенный в \pprop{th-func-cl}, можно доопределить до $2$-функтора.
...
Для любого объекта $\C$ категории $\fs{Cl}^\lambda$ у нас есть теория $\fs{Th}^\lambda(\C)$, которая является расслоенной по \dprop{th-fib}.
По \dprop{cl-th} категории $\C$ и $\fs{Cl}'(\fs{Th}^\lambda(\C))$ эквивалентны.
...
По \dlem{part-mono} морфизм $\{ \overline{x} : \overline{s} \mid R(\overline{x}) \}) \to \{ \overline{x} : \overline{s} \mid \top \}$ является мономорфизмом.
...
\end{thm}
\begin{proof}
Так как все морфизмы в $\Th^\lambda_\mathcal{S}$ являются корасслоениями, то по \dlem{all-cof} нам достаточно показать, что $\bcat{Cart}^\lambda_\mathcal{S}$ биэквивалентна категории расслоенных объектов $\Th^\lambda_\mathcal{S}$.
...
Тогда мы можем построить морфизм $f : T \to T'$ в $\Th^\lambda_\mathcal{S}$ такой, что $\fs{Cl}^\lambda_\mathcal{S}(f) \simeq F$, аналогично конструкции из \othm{th-inf-cat}.
...
Категория $\fs{Cl}^\lambda(\fs{Th}^\lambda(\C))$ является естественным образом объектом $\bcat{Cart}^\lambda_\mathcal{S}$, и эквивалентность, определенная в \pprop{cl-th}, является эквивалентностью в $\bcat{Cart}^\lambda_\mathcal{S}$.
...
\emph{Модельная теория} -- это теория $T$ вместе с двумя множествами $\I_T$ и $\J_T$ морфизмов категории $\Mod{T}$ таких, что $\I_T \subseteq \J_T$.
По \dprop{cart-mod-dual} морфизм категории $\Mod{T}$ можно представить в виде морфизма классифицирующей категории $T$.
Мы часто будет представлять такие морфизмы в обоих видах.
