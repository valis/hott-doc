...
\begin{defn}
(Полу)модельная категория $\C$ является \emph{корасслоено поражденной}, если она кополна и в качестве классов $\I$ и $\J$ в \pprop{model-cat} (в \pprop{semimodel-cat}) можно выбрать множества, допускающие аргумент малых объектов.
