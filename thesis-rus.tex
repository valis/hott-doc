...
По \dlem{th-aft} это верно и для теорий вида $(\mathcal{S},\varnothing,\varnothing,\varnothing)$.
...
Таким образом, по \dlem{th-aft} любой объект $\cat{D}$ удовлетворяет SCC по отношению ко всем теориям.
\end{proof}
