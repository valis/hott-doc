...
Тривиальные корасслоения замкнуты относительно трансфинитных композиций.
\end{lem}
\begin{proof}
...
Доказанный выше факт влечет, что функтор $\cat{C}_{F_0} \to \cat{C}_{F_\lambda}$ является полным.
...
так как любой морфизм из $\Icof[\J^\lambda]$ является ретрактом трансфинитной композиции таких морфизмов.
...
Этот функтор является левым сопряженным по \dprop{th-adj}.
По \dprop{transferred} нам достаточно проверить, что 
