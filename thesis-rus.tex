...
Очевидно, что для любого морфизма теорий $f : T \to T'$ у нас есть равенства $f \circ id_T = id_{T'} \circ f = f$.
...
Таким образом, для всех $\lambda$ и $\mu \geq \lambda$ мы получаем 2-категорию теорий, которую мы будем обозначать $(\lambda,\mu)\text{-}\Th$.
...
Мы будем говорить, что такой терм определен в некоторой теории, если в ней выводимы сигнатуры $t_k\!\downarrow\ \sststile{}{\amalg_{i \in I} \FV(s_i)} \varphi_i$ для всех $k \in K$ и $i \in I$
и сигнатура $\bigwedge_{i \in I} \varphi_i \sststile{}{\amalg_{i \in I} \FV(s_i)} \psi[\{t_k/k\}_{k \in K}]$.
