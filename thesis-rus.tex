...
Морфизм между объектами $s = \{ \overline{x} : \prod V \mid \varphi \}$ и $s' = \{ \overline{x} : \prod W \mid \psi \}$ -- это класс эквивалентности производных термов $\{ t_k \}_{k \in W}$ сигнатуры $s \to s'$ таких,
